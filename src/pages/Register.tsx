  ...
  const onSubmit = async (data: RegisterFormValues) => {
    ...
    try {
      ...
      toast({
        ...
        description:
          'Recebemos seu cadastro e um e-mail foi enviado a você. Aguarde a aprovação do administrador para acessar.',
      })
      setTimeout(() => {
        navigate('/login')
      }, 4000)
      ...
      <div className="w-full max-w-md space-y-8">
        <div className="flex flex-col items-center justify-center">
          ...
          <p className="mt-2 text-sm text-muted-foreground text-center">
            Cadastre-se na plataforma. Seu acesso será liberado após a avaliação
            do administrador.
          </p>
        </div>
